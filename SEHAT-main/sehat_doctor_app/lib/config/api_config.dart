class ApiConfig {
  ...
  static const String verifyPharmacyEndpoint =
      '$apiVersion/auth/verify/pharmacy';
  ...
  static const String doctorAvailabilityEndpoint =
      '$apiVersion/doctors/availability';
  static const String doctorAppointmentsEndpoint =
      '$apiVersion/doctors/appointments';
  static const String doctorConsultationsEndpoint =
      '$apiVersion/doctors/consultations';
  static const String doctorNotificationsEndpoint =
      '$apiVersion/doctors/notifications';
  ...
  static const String doctorPrescriptionsEndpoint =
      '$apiVersion/doctors/prescriptions';
  static const String doctorHealthRecordsEndpoint =
      '$apiVersion/doctors/health-records';
  static const String doctorMessagesEndpoint = '$apiVersion/doctors/messages';

  // Patient endpoints
  static const String patientHealthRecordsEndpoint =
      '$apiVersion/doctors/patients';
  ...
  // AI endpoints
  static const String aiSymptomAnalysisEndpoint = '$apiVersion/ai/symptom-analysis';
  static const String aiHealthRecommendationsEndpoint = '$apiVersion/ai/health-recommendations';
  static const String aiEmergencyCheckEndpoint = '$apiVersion/ai/emergency-check';
